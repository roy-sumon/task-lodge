...
const MidleSection = () => {
  return (
    <div className="px-5 sm:px-[10rem] mt-48">
      ...
      <div className="flex flex-col sm:flex-row gap-7 mt-10">
        ...
        <img className="sm:w-[23rem] h-[20rem] rounded-xl" src={house_2} alt="" />
      </div>
      <div className="flex flex-col sm:flex-row gap-5 mt-5 mb-8">
        <img className="sm:w-[24rem] h-[20rem] rounded-xl" src={house_3} alt="" />
        <img className="sm:w-[24rem] h-[20rem] rounded-xl" src={house_4} alt="" />
        <img className="sm:w-[24rem] h-[20rem] rounded-xl" src={house_5} alt="" />
      </div>
